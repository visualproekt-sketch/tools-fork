...
class MI_OT_Wrap_Scale(bpy.types.Operator):
...
class MI_OT_Wrap_Master(bpy.types.Operator):
    ...
    def execute(self, context: Context):
        ...
        bvh = mathu.bvhtree.BVHTree.FromObject(uv_obj, context.evaluated_depsgraph_get())
